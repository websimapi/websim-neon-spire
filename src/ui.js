    ...
    initListeners() {
        ...
        document.getElementById('btn-replay').addEventListener('click', async () => {
            if (this.lastReplayData) {
                ...
                // Dynamic import to load React only when needed
                try {
                    const { mountReplay } = await import('./video/mount.jsx');
                    mountReplay(document.getElementById('replay-container'), this.lastReplayData);
                } catch (e) {
        ...
        document.getElementById('btn-close-replay').addEventListener('click', async () => {
            document.getElementById('replay-modal').classList.remove('active');
            try {
                const { unmountReplay } = await import('./video/mount.jsx');
                unmountReplay(document.getElementById('replay-container'));
